  ...
  return (
    <div className="w-full h-screen flex justify-center items-center">
        <div className="w-[300px] lg:w-[400px] h-[350px] shadow-md rounded-md flex flex-col justify-center items-center py-[20px] px-[20px]">
            ...
            <h2 className='text-[#1a73e8] font-semibold text-[22px] mt-[15px]'>Welcome Back</h2>
            ...
            <form className='w-[90%] flex  flex-col justify-center items-center gap-3 mt-4' action="" onSubmit={Submit}>
  ...
  
                {
                    ...
                    <>
                        ...
                        <NavLink className="w-full" to="/home"><button className='h-[47px] w-full bg-[#1a73e8] text-white font-semibold outline-none' type='submit'>Signin</button></NavLink>
                        )
                    }
            </form>

            <h2 className='text-[14px] mt-4'>Don't have an Account? <NavLink to="/signup"><span className='text-[#1a73e8] cursor-pointer '>Signup</span></NavLink></h2>
        </div>
    </div>
  )
}
